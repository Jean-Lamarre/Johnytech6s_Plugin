...
import com.DjembeInc.johnytechPlugin.JohnytechPlugin;
...
public class PuppeterHandler {
	...
	public void UnmorphMob(Player ep) {
		...
		DMHandler.getInstance().DmInvisibility(p);
		DMHandler.getInstance().DmVision(p);
	 ...
	 * @param armorStand
	 */
	public void MorphInArmorStand(Player p, ArmorStand armorStand, EquipmentSlot selectedEquipment,
			ItemStack itemHold) {

		EntityEquipment armorStandEquipement = armorStand.getEquipment();
		ItemStack EEitemInMainHand = armorStandEquipement.getItemInMainHand();
	 ...
	 * @return
	 */
	public boolean TogglePuppeterMode(Player player) {
	...
	public boolean setPuppeterMode(Player player, boolean hasPuppeterPower) {
